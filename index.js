...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(array){
    const animalLowerCase = array.map(array => (array.animal_name.toLowerCase()));
  ...
  */
  ...
  function lowPopulationAnimals(array){
    const lowPopulationList = array.filter(array => array.population < 5);
  ...
  */
  ...
  console.log('callbacks, step 1', consume(3, 3, add));
...
function add(a, b){
  ...
  console.log('callbacks, step 2', add(9, 9));
...
function multiply(a, b){
  ...
  console.log('callbacks, step 2', multiply(3, 9));
...
function greeting(firstName, lastName){
  ...
  console.log('callbacks, step 2', greeting('John', 'Wick'));
...
const cuboidCube = new CubeMaker({
  length: 9,
  width: 9,
  height: 9
});
